...
case class Version(version: Int, link: String, protection: Protection)
...
object Version {
  ...
  implicit object VersionFormat extends Format[Version] {
    ...
    override def writes(o: Version): JsValue =
      Json.obj("version" -> o.version, "link" -> o.link)
  ...
  val dummyProtection = new Protection("nino", 1L, 1, 1, 1, None, None, None)
}
